...
export const DEFAULT_INNOVATION_ITEMS: InnovationItem[] = [
  {
    id: 1,
    title: 'แผนการจัดการเรียนรู้ดิจิทัลและคู่มือนวัตกรรมเชิงรุก (Active Learning Plan)',
    category: 'แผนการจัดการเรียนรู้และนวัตกรรม',
    status: 'approved',
    submittedDate: '10 มี.ค. 2569',
    linkUrl: 'https://drive.google.com',
    notes: 'แผนการสอนบูรณาการเทคโนโลยี AI & ดิจิทัล ผ่านเกณฑ์ประเมินระดับดีเด่น',
  },
  {
    id: 2,
    title: 'สื่อวิดีโอนวัตกรรมและบทเรียนปฏิสัมพันธ์ (Interactive Video & VR Learning)',
    category: 'สื่อมัลติมีเดียและดิจิทัล',
    status: 'approved',
    submittedDate: '12 มี.ค. 2569',
    linkUrl: 'https://youtube.com',
    notes: 'วิดีโอคลิปการสอนความละเอียดสูง 4K พร้อมแบบฝึกหัดโต้ตอบอัตโนมัติ',
  },
  {
    id: 3,
    title: 'สื่อนวัตกรรมเกมจำลองสถานการณ์เพื่อการเรียนรู้ (Gamified Simulation Kit)',
    category: 'สื่อนวัตกรรมสร้างสรรค์',
    status: 'submitted',
    submittedDate: '15 มี.ค. 2569',
    linkUrl: 'https://acu.ac.th',
    notes: 'แบบจำลองจำลองปฏิบัติการทางวิทยาศาสตร์และคณิตศาสตร์ ส่งรอบประกวดโรงเรียน',
  },
  {
    id: 4,
    title: 'คลังแบบทดสอบและเครื่องมือประเมินสมรรถนะผู้เรียน (Competency Evaluation Bank)',
    category: 'การวัดและประเมินผล',
    status: 'under_review',
    submittedDate: '16 มี.ค. 2569',
    linkUrl: '',
    notes: 'ข้อสอบมาตรฐานและเกณฑ์รูบริกส์ (Rubrics Score) อยู่ระหว่างการตรวจสอบของฝ่ายวิชาการ',
  },
  {
    id: 5,
    title: 'รายงานผลการใช้นวัตกรรมการศึกษาเพื่อยกระดับผลสัมฤทธิ์ (Action Research & Impact Report)',
    category: 'รายงานวิจัยและผลงานนวัตกรรม',
    status: 'pending',
    submittedDate: '-',
    linkUrl: '',
    notes: 'กำลังจัดทำรายงานสังเคราะห์ผลสัมฤทธิ์และข้อเสนอแนะประจำภาคเรียน',
  },
];
...
export async function fetchFullUserProfile(
  ...
  const defaultProfile: FullUserProfile = cached || {
    email: email,
    fullName: initialDisplayName || 'มาสเตอร์วีระพงศ์ คำสอน',
    nickname: 'ครูปอย',
